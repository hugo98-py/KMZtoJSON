...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link url="Server=172.22.110.36; Service=5151; Database=sde; User=geosde; Version=SDE.DEFAULT" format="" description="" name="SDE Feature Class" mimeType="" size="" type="ArcSDE Connection"/>
  </links>
  <dates/>
  <fees></fees>
